        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3 border-dark " style="width: 30rem;">
            ...
            <div class="card-body">
              ...
              <form action="<?= base_url('fitur/Forminput/form_input_tani') ?>" method="post" enctype="multipart/form-data"><!--multipart/form-data berfungsi supaya file dapat diambil -->
                <div class="form-group">
                  <label for="idmakanan">Id Produk</label>
                  <input type="text" name="id_produk" class="form-control" id="idmakanan" aria-describedby="makanan" placeholder="id produk" readonly value="<?php echo $kode; ?>">
                  ...
                  <input type="file" name="image" class="form-control" value="Pilih gambar" required oninvalid="this.setCustomValidity('Silahkan pilih gambar terlebih dahulu')">
                </div>
