  ...
  <body id="page-top">
    ...
    <thead>
      <tr>
        ...
        <th width="20%">Nama Produk Olahan</th>
        <th>Options</th>     
      </tr>
    </thead>
    <tbody>
      ...
      <tr>
        ...
        <td><i class="fas fa-pen"><?php echo anchor('crud/hapus/'.$dt->id_produk); ?></i>
            <a href="" class="btn btn-danger small"><i class="fas fa-trash"></i></a>
          </td>
      </tr>
      <?php } ?>
