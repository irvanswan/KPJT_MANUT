...
<body id="page-top">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#services">Tentang Organisasi</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#contact">Struktur Organisasi</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#about">Kegiatan Organisasi</a>
          </li>
          <li class="nav-item">
  ...
  <section class="page-section" id="services">
    <div class="container">
      ...
      <div class="row text-center">
        <div class="col-md-4">
          <a class="portfolio-link" data-toggle="modal" href="#pembudidaya1">
        ...
        <div class="col-md-4">
          <span class="fa-stack fa-4x">
            <a class="portfolio-link" data-toggle="modal" href="#olahan1">
              <i class="fas fa-circle fa-stack-2x text-primary"></i>
        ...
        <div class="col-md-4">
          <span class="fa-stack fa-4x">
            <a class="portfolio-link" data-toggle="modal" href="#pengiriman1">
              <i class="fas fa-circle fa-stack-2x text-primary"></i>
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#portfolioModal1">
            ...
            <img class="img-fluid" src="<?php echo base_url('assets/gambar_produk/'.$pd->gambar_produk)?>" width='500' height='500' alt="">
          </a>
          <div class="portfolio-caption">
            <h4><?php echo $pd->nm_produk ?></h4>
            <p class="text-muted">Bakso jamur tiram adalah</p>
          </div>
        </div>
        <?php } ?>
      </div>
  ...
  <!-- Modal Pembudidaya -->
  <div class="modal fade" id="pembudidaya1" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalScrollableTitle">Pembudidaya</h5>
            ...
            <div class="container">
              <div class="row">
                <div class="col text-center" style="padding-top: 125px; padding-bottom: 125px;">
                  <h2 class="section-heading text-uppercase">Tentang Organisasi</h2>
                  <h3 class="section-subheading text-muted">Pembudidaya Jamur.</h3>
                </div>
              </div>
  ...
  <!-- Modal Produksi Olahan -->
  <div class="modal fade" id="olahan1" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalScrollableTitle">Unit Produksi Olahan</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
  ...
  <!-- Modal pengiriman -->
  <div class="modal fade" id="pengiriman1" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalScrollableTitle">Unit Pengiriman</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
            <div class="container">
              <div class="row">
                <div class="col text-center" style="padding-top: 125px; padding-bottom: 125px;">
                  <h2 class="section-heading text-uppercase">Tentang Organisasi</h2>
                  <h3 class="section-subheading text-muted">Pengiriman.</h3>
                </div>
              </div>
              <div class="text-justify">
